...
?>
<h2>Accounts</h2>
<p><a href="/app/accounts/create.php">+ Add Account</a></p>
...
<table border="1" cellpadding="8">
  ...
  <tr>
    ...
    <td>
      <a href="/app/accounts/edit.php?id=<?=$r['local_account_id']?>">Edit</a> |
      <a href="/app/accounts/toggle.php?id=<?=$r['local_account_id']?>"><?=$r['is_active']?'Deactivate':'Activate'?></a>
    </td>
  </tr>
  <?php endforeach; ?>
</table>
